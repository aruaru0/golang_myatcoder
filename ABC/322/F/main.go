...
func add(a, b D, aw, bw int) D {
	var c D
	c.mx = nmax(a.mx, b.mx, a.r+b.l)
	if a.l == aw {
		c.l = b.l + aw
	} else {
		c.l = a.l
...
func merge(a, b S) S {
	var c S
	c.w = a.w + b.w
	c.d0 = add(a.d0, b.d0, a.w, b.w)
	c.d1 = add(a.d1, b.d1, a.w, b.w)
	return c
}
...
func main() {
	...
	e := func() S { return S{0, D{0, 0, 0}, D{0, 0, 0}} }
	merger := func(a, b S) S { return merge(a, b) }
	...
	for i := 0; i < Q; i++ {
		c, l, r := getI(), getI()-1, getI()
		if c == 1 {
			seg.RangeApply(l, r, F{1})
		} else {
			ans := seg.Prod(l, r).d1.mx
			out(ans)
		}
	}
}
