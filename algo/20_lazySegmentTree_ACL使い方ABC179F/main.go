...
func main() {
	...
	wlseg := newLazySegtree(a, AffineE, AffileMerger, AffineMapper, AffineComp, AffineID)
	hlseg := newLazySegtree(a, AffineE, AffileMerger, AffineMapper, AffineComp, AffineID)
